...
- Return up to ${RECOMMEND_COUNT} recommendations (1-${RECOMMEND_COUNT} depending on availability)
- For small cities, return fewer if you can't find ${RECOMMEND_COUNT} real apartments
- For each apartment, provide REALISTIC latitude and longitude coordinates for the location
- Use coordinates that are accurate for the neighborhood mentioned
- For each apartment, provide a realistic image URL using real property photos if available, or use realistic placeholder images
- Example image URLs: https://images.unsplash.com/photo-... or https://example.com/apartment-image.jpg
- DO NOT leave the image field empty — always provide a URL
- Make sure latitude is between -90 and 90, longitude between -180 and 180
`.trim();
...
- Return 1-${RECOMMEND_COUNT} recommendations (return fewer if you can't find enough real apartments)
...
- Provide REALISTIC latitude and longitude for each apartment's location
- Use coordinates that match the neighborhood
- Latitude: between -90 and 90
- Longitude: between -180 and 180
- Example: Toronto downtown is approximately 43.6532, -79.3832

IMAGES (REQUIRED):
- Provide a REALISTIC image URL for EACH apartment
- Use real property images when possible
- Use Unsplash for placeholders: https://images.unsplash.com/photo-XXX?w=400
- Examples of good URLs:
  - https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=400
  - https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=400
  - https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=400
- DO NOT leave image empty — ALWAYS provide a URL

REQUIRED FIELDS (ALL REQUIRED):
- title, price, priceCAD, location, reason, neighborhoodInsight, bedrooms, description, withinBudget, latitude, longitude, image
